...
<button class="swap swap-rotate btn btn-ghost btn-circle" data-toggle-theme="dark" data-act-class="swap-active">
    <!-- sun icon -->
    ...
    <!-- moon icon -->
    <svg class="swap-on fill-current w-6 h-8" xmlns="http://www.w3.org/2000/svg" viewBox="0 0 24 24"
        ><path
